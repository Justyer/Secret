...
metadatas = ('所属省份','所属城市','所属区域','街道路','路牌号','小区名','小区别名','楼栋名','楼栋别名名','楼栋街牌号','单元名','单元别名名','单元街牌号','楼层名',
...
class wwwworldunioncombase(ParserBase):
    ...
    #参数匹配
    citys = {"1"  :("深圳","广东省"), "2" :("广州","广东省"), "3" :("北京","北京市"),  "4" :("上海", "上海市"), "5" : ("天津", "天津市"),
             "6"  :("重庆","重庆市"),   "7" :("珠海","广东省"), "8" :("惠州","广东省"),"9" :("东莞", "广东省"),
             "11" :("河源","广东省"), "12":("清远","广东省"),
             "16" :("江门","广东省"), "17":("佛山","广东省"),
             ...
             "88" :("苏州","江苏省"),
             #"88" :"福州",
             "93" :("黄石","江苏省"), "94" :("无锡","江苏省"),"95": ("三亚","海南省"), "96" :("常州","江苏省"),
             "97" :("温州","浙江省"), "98" :("宜昌","湖北省"),"101": ("金华","浙江省"),
             "102":("烟台","山东省"), "105":("潍坊","山东省"),"114":("西宁","青海省"),
             "120":("台州","浙江省"),"125":("株洲","湖南省"),"189":("中山","广东省"),"285":("湘潭","湖南省")}
...
if __name__ == '__main__':
    ...
    wwwex.getConInfo(UrlBean('getConInfo/17-82922', 'wwwworldunioncomex#getConInfo',
                                  param=dict(CityId='17', conid='82922'), order='1234567890'))
    ...
    # wwwex.getHouseInfo(UrlBean("getHouseInfo/", 'wwwworldunion#getHouseInfo',
    #                             param=dict(CityId='7', HouseId='21094589',
    #                                        ud=dict({})), order='0123456789'))

    #print('"%s", IP, PID' %'","'.join([meta for meta in metadatas]))
    #print('%s, :IP, :PID' %','.join([":%s" % meta for meta in metadatas]))
