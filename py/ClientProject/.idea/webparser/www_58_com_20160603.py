...
if __name__ == '__main__':
    ...
    # w58.getitem(UrlBean('http://lasa.58.com/ershoufang/25724025285678x.shtml', 'www58com#getpages', param='北京',order='12345632156'))
    ...
    #         print(item.url)
    with open("D:\\data\\58.tsv", "r", encoding='gbk') as f:
        for idx, line in enumerate(f.readlines()):
            if idx+1<428:
                continue
            print("\n\n", idx+1, "\n", line.strip())
            w58.getitem(UrlBean(line.strip(), 'wwwajkcom#getitem', param=9, headers='哈尔滨',order='1604121053'))